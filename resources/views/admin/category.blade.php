            ...
            <div id="form" class="column col-12 col-md-12">
                <div class="card padding30">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name',null,["class"=>"form-input", "placeholder"=>"请输入新建题库的名称"]) !!}
                        {!! Form::label('题目',null,["class"=>"form-label"]) !!}
                        {!! Form::text('question',null,["class"=>"form-input", "placeholder"=>"请输入该题库下题目的编号，使用英文逗号分隔开"]) !!}
                        {!! Form::label('排序',null,["class"=>"form-label"]) !!}
                        {!! Form::text('no',null,["class"=>"form-input", "placeholder"=>"请输入该题库显示的排序"]) !!}
                    </div>
